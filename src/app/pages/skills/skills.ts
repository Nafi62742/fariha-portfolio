...
import { SkillCategory, AnalyticalSkill } from '@models/portfolio.models';
...
export class SkillsComponent {
  ...
  /** All analytical and business skills loaded from the portfolio service. */
  public readonly analyticalSkills: Array<AnalyticalSkill>;
  ...
  constructor() {
    ...
    this.analyticalSkills = this.portfolio.getAnalyticalSkills();
  }
}
